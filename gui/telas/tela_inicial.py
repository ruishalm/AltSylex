...
class TelaInicial(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        self.gerar_disco_persona_button = BotaoOrganico(self, text="Gerar Disco de Persona", command=self.app.gerar_disco_persona, cursor="hand2")
        self.gerar_disco_persona_button.pack(pady=10)

        self.ver_dados_button = BotaoOrganico(self, text="Ver Dados", command=self.app.ver_dados, cursor="hand2")
        self.ver_dados_button.pack(pady=10)
